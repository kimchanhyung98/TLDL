...
class TextAnalyzer:
    ...
    def extract_important_content(self, text):
        ...
        response = self.client.chat.completions.create(
            model=self.model,
            messages=[
                {"role": "system", "content": "You are an assistant that helps students analyze lecture content. Your role is to accurately extract important information from lecture transcripts."},
